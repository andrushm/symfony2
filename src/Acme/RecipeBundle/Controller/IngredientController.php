...
use Acme\RecipeBundle\Entity\Ingredient;
use Acme\RecipeBundle\Form\IngredientType;
...
class IngredientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeRecipeBundle:Ingredient')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeRecipeBundle:Ingredient:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeRecipeBundle:Ingredient')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeRecipeBundle:Ingredient:edit.html.twig")
     */
