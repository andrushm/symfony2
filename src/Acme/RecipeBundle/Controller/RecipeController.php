...
use Acme\RecipeBundle\Entity\Recipe;
use Acme\RecipeBundle\Form\RecipeType;
...
class RecipeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeRecipeBundle:Recipe')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeRecipeBundle:Recipe:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeRecipeBundle:Recipe')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeRecipeBundle:Recipe:edit.html.twig")
     */
